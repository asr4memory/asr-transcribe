...
def test_uppercase_sentences():
    segment1 = {"text": "The first sentence is not affected.",
                "start": 0.0, "end": 0.0}
    segment2 = {"text": "the sentences after that are affected,",
                "start": 0.0, "end": 0.0}
    segment3 = {"text": "unless there is a comma before them.",
                "start": 0.0, "end": 0.0}
...
def test_split_sentences():
    segment1 = {"text": "This sentence is way shorter than 120 characters.",
                "start": 0.0, "end": 10.0}
    segment2 = {"text": ("This sentence is longer than 120 characters "
                             ...
                             "of one."),
                "start": 10.0, "end": 40.0}
    segment3 = {"text": "The last sentence is also below 120 characters.",
                "start": 40.0, "end": 50.0}
    original_segments = [segment1, segment2, segment3]

    segment2a = {"text": ("This sentence is longer than 120 characters "
                              "and it should be broken up into two sentences "
                              "after the comma appearing shortly after 120,"),
                 "start": 10.0, "end": 31.157894736842106}
    segment2b = {"text": ("and so in the end we have two sentences instead "
                              "of one."),
