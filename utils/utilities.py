...
def prepare_bag_directory(bag_root: Path) -> Path:
    ...
    content_extraction_dir = data_dir / "content_extraction"
    content_extraction_dir.mkdir()
...
def finalize_bag(
    ...
    bag_info.setdefault(
        ...
        (
            ...
            "The /content_extraction directory contains LLM-generated content such as summaries and table of contents."
