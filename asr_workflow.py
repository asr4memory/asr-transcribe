...
def process_file(filepath: Path, output_directory: Path):
    ...
    try:
        ...
        translation_custom_segs = None
        translation_word_segments = None
        if translation_payload:
            translation_custom_segs = process_whisperx_segments(
                translation_payload["segments"]
            )
            translation_word_segments = translation_payload.get("word_segments")
        ...
        if translation_payload:
            ...
            write_output_files(
                ...
                all=translation_payload,
                segments=translation_custom_segs or [],
                word_segments=translation_word_segments or [],
                summaries=None,
            )
